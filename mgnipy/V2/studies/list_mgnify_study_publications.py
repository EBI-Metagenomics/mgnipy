...
from mgnipy.V2.mgni_py_v2.models.ninja_pagination_response_schema_m_gnify_publication import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/metagenomics/api/v2/studies/{accession}/publications/".format(
