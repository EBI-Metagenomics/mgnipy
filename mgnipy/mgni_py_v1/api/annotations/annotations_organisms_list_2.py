...
from ...models.annotations_organisms_list_2_format import (
...
def _get_kwargs(
    lineage: str,
    *,
    format_: AnnotationsOrganismsList2Format | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/annotations/organisms/{lineage}".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> PaginatedOrganismList | None:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        lineage (str):
        format_ (AnnotationsOrganismsList2Format | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
