...
from ...models.annotations_kegg_orthologs_analyses_list_format import (
...
def _get_kwargs(
    accession: str,
    *,
    format_: AnnotationsKeggOrthologsAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/annotations/kegg-orthologs/{accession}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnnotationsKeggOrthologsAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
