...
from ...models.annotations_pfam_entries_analyses_list_format import (
...
def _get_kwargs(
    accession: str,
    *,
    format_: AnnotationsPfamEntriesAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/annotations/pfam-entries/{accession}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnnotationsPfamEntriesAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
