...
def _get_kwargs(
    accession: str,
    *,
    format_: AnalysesTaxonomyItsonedbListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analyses/{accession}/taxonomy/itsonedb".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnalysesTaxonomyItsonedbListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
