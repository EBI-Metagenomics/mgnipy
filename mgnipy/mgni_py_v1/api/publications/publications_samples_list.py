...
from ...models.publications_samples_list_format import PublicationsSamplesListFormat
...
def _get_kwargs(
    pubmed_id: str,
    *,
    format_: PublicationsSamplesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/publications/{pubmed_id}/samples".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        pubmed_id (str):
        format_ (PublicationsSamplesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
