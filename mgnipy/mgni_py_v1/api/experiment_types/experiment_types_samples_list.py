...
from ...models.experiment_types_samples_list_format import (
...
def _get_kwargs(
    experiment_type: str,
    *,
    format_: ExperimentTypesSamplesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/experiment-types/{experiment_type}/samples".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        experiment_type (str):
        format_ (ExperimentTypesSamplesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
