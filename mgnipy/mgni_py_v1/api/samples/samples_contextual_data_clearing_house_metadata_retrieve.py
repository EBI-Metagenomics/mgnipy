...
from ...models.samples_contextual_data_clearing_house_metadata_retrieve_format import (
...
def _get_kwargs(
    accession: str,
    *,
    format_: SamplesContextualDataClearingHouseMetadataRetrieveFormat | Unset = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/samples/{accession}/contextual_data_clearing_house_metadata".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (SamplesContextualDataClearingHouseMetadataRetrieveFormat | Unset):
