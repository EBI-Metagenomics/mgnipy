...
from ...models.samples_runs_list_format import SamplesRunsListFormat
...
def _get_kwargs(
    accession: str,
    *,
    format_: SamplesRunsListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/samples/{accession}/runs".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (SamplesRunsListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
