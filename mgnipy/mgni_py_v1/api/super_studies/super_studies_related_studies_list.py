...
from ...models.super_studies_related_studies_list_format import (
...
def _get_kwargs(
    super_study_id: str,
    *,
    format_: SuperStudiesRelatedStudiesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/super-studies/{super_study_id}/related-studies".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        super_study_id (str):
        format_ (SuperStudiesRelatedStudiesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
