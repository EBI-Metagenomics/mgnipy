...
if TYPE_CHECKING:
    from ..models.study_download import StudyDownload


T = TypeVar("T", bound="PaginatedStudyDownloadList")


@_attrs_define
class PaginatedStudyDownloadList:
    """
    Attributes:
        ...
        results (list[StudyDownload] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[StudyDownload] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = StudyDownload.from_dict(results_item_data)

                results.append(results_item)

        paginated_study_download_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_study_download_list.additional_properties = d
        return paginated_study_download_list
