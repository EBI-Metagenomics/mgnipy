...
T = TypeVar("T", bound="PaginatedAntiSmashGeneClusterList")


@_attrs_define
class PaginatedAntiSmashGeneClusterList:
    """
    Attributes:
        ...
        results (list[AntiSmashGeneCluster] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[AntiSmashGeneCluster] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = AntiSmashGeneCluster.from_dict(results_item_data)

                results.append(results_item)

        paginated_anti_smash_gene_cluster_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_anti_smash_gene_cluster_list.additional_properties = d
        return paginated_anti_smash_gene_cluster_list
