...
T = TypeVar("T", bound="PaginatedSuperStudyList")


@_attrs_define
class PaginatedSuperStudyList:
    """
    Attributes:
        ...
        results (list[SuperStudy] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[SuperStudy] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = SuperStudy.from_dict(results_item_data)

                results.append(results_item)

        paginated_super_study_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_super_study_list.additional_properties = d
        return paginated_super_study_list
