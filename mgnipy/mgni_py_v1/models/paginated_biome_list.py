...
T = TypeVar("T", bound="PaginatedBiomeList")


@_attrs_define
class PaginatedBiomeList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = Biome.from_dict(results_item_data)

                results.append(results_item)

        paginated_biome_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_biome_list.additional_properties = d
        return paginated_biome_list
