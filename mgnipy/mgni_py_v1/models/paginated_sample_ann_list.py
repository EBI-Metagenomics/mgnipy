...
if TYPE_CHECKING:
    from ..models.sample_ann import SampleAnn


T = TypeVar("T", bound="PaginatedSampleAnnList")


@_attrs_define
class PaginatedSampleAnnList:
    """
    Attributes:
        ...
        results (list[SampleAnn] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[SampleAnn] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = SampleAnn.from_dict(results_item_data)

                results.append(results_item)

        paginated_sample_ann_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_sample_ann_list.additional_properties = d
        return paginated_sample_ann_list
