...
if TYPE_CHECKING:
    from ..models.cog_count import CogCount


T = TypeVar("T", bound="PaginatedCogCountList")


@_attrs_define
class PaginatedCogCountList:
    """
    Attributes:
        ...
        results (list[CogCount] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[CogCount] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = CogCount.from_dict(results_item_data)

                results.append(results_item)

        paginated_cog_count_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_cog_count_list.additional_properties = d
        return paginated_cog_count_list
