...
T = TypeVar("T", bound="PaginatedInterproIdentifierList")


@_attrs_define
class PaginatedInterproIdentifierList:
    """
    Attributes:
        ...
        results (list[InterproIdentifier] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[InterproIdentifier] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = InterproIdentifier.from_dict(results_item_data)

                results.append(results_item)

        paginated_interpro_identifier_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_interpro_identifier_list.additional_properties = d
        return paginated_interpro_identifier_list
