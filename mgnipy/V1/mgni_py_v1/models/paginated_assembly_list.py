...
T = TypeVar("T", bound="PaginatedAssemblyList")


@_attrs_define
class PaginatedAssemblyList:
    """
    Attributes:
        ...
        results (list[Assembly] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[Assembly] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = Assembly.from_dict(results_item_data)

                results.append(results_item)

        paginated_assembly_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_assembly_list.additional_properties = d
        return paginated_assembly_list
