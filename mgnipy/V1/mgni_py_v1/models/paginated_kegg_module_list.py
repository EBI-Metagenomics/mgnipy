...
T = TypeVar("T", bound="PaginatedKeggModuleList")


@_attrs_define
class PaginatedKeggModuleList:
    """
    Attributes:
        ...
        results (list[KeggModule] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[KeggModule] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = KeggModule.from_dict(results_item_data)

                results.append(results_item)

        paginated_kegg_module_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_kegg_module_list.additional_properties = d
        return paginated_kegg_module_list
