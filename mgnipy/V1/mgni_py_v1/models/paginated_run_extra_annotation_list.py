...
T = TypeVar("T", bound="PaginatedRunExtraAnnotationList")


@_attrs_define
class PaginatedRunExtraAnnotationList:
    """
    Attributes:
        ...
        results (list[RunExtraAnnotation] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[RunExtraAnnotation] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = RunExtraAnnotation.from_dict(results_item_data)

                results.append(results_item)

        paginated_run_extra_annotation_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_run_extra_annotation_list.additional_properties = d
        return paginated_run_extra_annotation_list
