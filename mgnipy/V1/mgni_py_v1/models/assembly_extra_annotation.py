...
T = TypeVar("T", bound="AssemblyExtraAnnotation")


@_attrs_define
class AssemblyExtraAnnotation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assembly_extra_annotation.additional_properties = d
        return assembly_extra_annotation
