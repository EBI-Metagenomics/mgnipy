...
T = TypeVar("T", bound="PaginatedExperimentTypeList")


@_attrs_define
class PaginatedExperimentTypeList:
    """
    Attributes:
        ...
        results (list[ExperimentType] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[ExperimentType] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = ExperimentType.from_dict(results_item_data)

                results.append(results_item)

        paginated_experiment_type_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_experiment_type_list.additional_properties = d
        return paginated_experiment_type_list
