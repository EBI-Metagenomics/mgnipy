...
T = TypeVar("T", bound="InterproIdentifier")


@_attrs_define
class InterproIdentifier:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        interpro_identifier = cls(
            accession=accession,
            url=url,
            description=description,
        )

        interpro_identifier.additional_properties = d
        return interpro_identifier
