...
T = TypeVar("T", bound="PaginatedGenomeFragmentSearchList")


@_attrs_define
class PaginatedGenomeFragmentSearchList:
    """
    Attributes:
        ...
        results (list[GenomeFragmentSearch] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[GenomeFragmentSearch] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = GenomeFragmentSearch.from_dict(results_item_data)

                results.append(results_item)

        paginated_genome_fragment_search_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_genome_fragment_search_list.additional_properties = d
        return paginated_genome_fragment_search_list
