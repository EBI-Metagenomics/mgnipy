...
if TYPE_CHECKING:
    from ..models.organism_retrive import OrganismRetrive


T = TypeVar("T", bound="PaginatedOrganismRetriveList")


@_attrs_define
class PaginatedOrganismRetriveList:
    """
    Attributes:
        ...
        results (list[OrganismRetrive] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[OrganismRetrive] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = OrganismRetrive.from_dict(results_item_data)

                results.append(results_item)

        paginated_organism_retrive_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_organism_retrive_list.additional_properties = d
        return paginated_organism_retrive_list
