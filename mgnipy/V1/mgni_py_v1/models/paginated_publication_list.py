...
T = TypeVar("T", bound="PaginatedPublicationList")


@_attrs_define
class PaginatedPublicationList:
    """
    Attributes:
        ...
        results (list[Publication] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[Publication] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = Publication.from_dict(results_item_data)

                results.append(results_item)

        paginated_publication_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_publication_list.additional_properties = d
        return paginated_publication_list
