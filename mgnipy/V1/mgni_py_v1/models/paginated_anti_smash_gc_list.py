...
T = TypeVar("T", bound="PaginatedAntiSmashGCList")


@_attrs_define
class PaginatedAntiSmashGCList:
    """
    Attributes:
        ...
        results (list[AntiSmashGC] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[AntiSmashGC] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = AntiSmashGC.from_dict(results_item_data)

                results.append(results_item)

        paginated_anti_smash_gc_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_anti_smash_gc_list.additional_properties = d
        return paginated_anti_smash_gc_list
