...
T = TypeVar("T", bound="PaginatedKeggOrthologList")


@_attrs_define
class PaginatedKeggOrthologList:
    """
    Attributes:
        ...
        results (list[KeggOrtholog] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[KeggOrtholog] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = KeggOrtholog.from_dict(results_item_data)

                results.append(results_item)

        paginated_kegg_ortholog_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_kegg_ortholog_list.additional_properties = d
        return paginated_kegg_ortholog_list
