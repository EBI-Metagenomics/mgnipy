...
if TYPE_CHECKING:
    from ..models.kegg_class_match import KeggClassMatch


T = TypeVar("T", bound="PaginatedKeggClassMatchList")


@_attrs_define
class PaginatedKeggClassMatchList:
    """
    Attributes:
        ...
        results (list[KeggClassMatch] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[KeggClassMatch] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = KeggClassMatch.from_dict(results_item_data)

                results.append(results_item)

        paginated_kegg_class_match_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_kegg_class_match_list.additional_properties = d
        return paginated_kegg_class_match_list
