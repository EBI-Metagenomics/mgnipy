...
if TYPE_CHECKING:
    from ..models.pfam_retrieve import PfamRetrieve


T = TypeVar("T", bound="PaginatedPfamRetrieveList")


@_attrs_define
class PaginatedPfamRetrieveList:
    """
    Attributes:
        ...
        results (list[PfamRetrieve] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[PfamRetrieve] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = PfamRetrieve.from_dict(results_item_data)

                results.append(results_item)

        paginated_pfam_retrieve_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_pfam_retrieve_list.additional_properties = d
        return paginated_pfam_retrieve_list
