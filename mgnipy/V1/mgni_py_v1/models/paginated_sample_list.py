...
T = TypeVar("T", bound="PaginatedSampleList")


@_attrs_define
class PaginatedSampleList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = Sample.from_dict(results_item_data)

                results.append(results_item)

        paginated_sample_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_sample_list.additional_properties = d
        return paginated_sample_list
