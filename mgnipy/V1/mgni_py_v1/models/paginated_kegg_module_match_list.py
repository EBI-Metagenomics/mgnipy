...
if TYPE_CHECKING:
    from ..models.kegg_module_match import KeggModuleMatch


T = TypeVar("T", bound="PaginatedKeggModuleMatchList")


@_attrs_define
class PaginatedKeggModuleMatchList:
    """
    Attributes:
        ...
        results (list[KeggModuleMatch] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[KeggModuleMatch] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = KeggModuleMatch.from_dict(results_item_data)

                results.append(results_item)

        paginated_kegg_module_match_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_kegg_module_match_list.additional_properties = d
        return paginated_kegg_module_match_list
