...
if TYPE_CHECKING:
    from ..models.anti_smash_count import AntiSmashCount


T = TypeVar("T", bound="PaginatedAntiSmashCountList")


@_attrs_define
class PaginatedAntiSmashCountList:
    """
    Attributes:
        ...
        results (list[AntiSmashCount] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[AntiSmashCount] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = AntiSmashCount.from_dict(results_item_data)

                results.append(results_item)

        paginated_anti_smash_count_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_anti_smash_count_list.additional_properties = d
        return paginated_anti_smash_count_list
