...
T = TypeVar("T", bound="PaginatedPfamList")


@_attrs_define
class PaginatedPfamList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = Pfam.from_dict(results_item_data)

                results.append(results_item)

        paginated_pfam_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_pfam_list.additional_properties = d
        return paginated_pfam_list
