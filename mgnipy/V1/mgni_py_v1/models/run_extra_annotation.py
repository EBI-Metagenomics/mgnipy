...
T = TypeVar("T", bound="RunExtraAnnotation")


@_attrs_define
class RunExtraAnnotation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_extra_annotation.additional_properties = d
        return run_extra_annotation
