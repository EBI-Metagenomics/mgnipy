...
if TYPE_CHECKING:
    from ..models.kegg_module_retrieve import KeggModuleRetrieve


T = TypeVar("T", bound="PaginatedKeggModuleRetrieveList")


@_attrs_define
class PaginatedKeggModuleRetrieveList:
    """
    Attributes:
        ...
        results (list[KeggModuleRetrieve] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[KeggModuleRetrieve] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = KeggModuleRetrieve.from_dict(results_item_data)

                results.append(results_item)

        paginated_kegg_module_retrieve_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_kegg_module_retrieve_list.additional_properties = d
        return paginated_kegg_module_retrieve_list
