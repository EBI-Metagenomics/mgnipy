...
T = TypeVar("T", bound="PaginatedPipelineToolList")


@_attrs_define
class PaginatedPipelineToolList:
    """
    Attributes:
        ...
        results (list[PipelineTool] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[PipelineTool] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = PipelineTool.from_dict(results_item_data)

                results.append(results_item)

        paginated_pipeline_tool_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_pipeline_tool_list.additional_properties = d
        return paginated_pipeline_tool_list
