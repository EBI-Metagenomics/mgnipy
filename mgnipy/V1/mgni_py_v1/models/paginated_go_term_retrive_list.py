...
if TYPE_CHECKING:
    from ..models.go_term_retrive import GoTermRetrive


T = TypeVar("T", bound="PaginatedGoTermRetriveList")


@_attrs_define
class PaginatedGoTermRetriveList:
    """
    Attributes:
        ...
        results (list[GoTermRetrive] | Unset):
    """

    count: int | Unset = UNSET
    next_: None | str | Unset = UNSET
    previous: None | str | Unset = UNSET
    results: list[GoTermRetrive] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = GoTermRetrive.from_dict(results_item_data)

                results.append(results_item)

        paginated_go_term_retrive_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_go_term_retrive_list.additional_properties = d
        return paginated_go_term_retrive_list
