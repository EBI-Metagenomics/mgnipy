...
T = TypeVar("T", bound="GenomeCatalogueDownload")


@_attrs_define
class GenomeCatalogueDownload:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        genome_catalogue_download.additional_properties = d
        return genome_catalogue_download
