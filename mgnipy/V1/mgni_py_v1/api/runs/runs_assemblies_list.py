...
from ...models.runs_assemblies_list_format import RunsAssembliesListFormat
...
def _get_kwargs(
    accession: str,
    *,
    format_: RunsAssembliesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/runs/{accession}/assemblies".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> PaginatedAssemblyList | None:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (RunsAssembliesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
