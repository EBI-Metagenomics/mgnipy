...
def _get_kwargs(
    ...
    alias: str,
    *,
    format_: RunsExtraAnnotationsRetrieveFormat | Unset = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/runs/{accession}/extra-annotations/{alias}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        alias (str):
        format_ (RunsExtraAnnotationsRetrieveFormat | Unset):
