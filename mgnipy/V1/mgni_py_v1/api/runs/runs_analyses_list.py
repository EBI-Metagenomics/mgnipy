...
from ...models.runs_analyses_list_format import RunsAnalysesListFormat
...
def _get_kwargs(
    accession: str,
    *,
    format_: RunsAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/runs/{accession}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (RunsAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
