...
from ...models.publications_studies_list_format import PublicationsStudiesListFormat
from ...types import (
    UNSET,
    Response,
    Unset,
...
def _get_kwargs(
    pubmed_id: str,
    *,
    format_: PublicationsStudiesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/publications/{pubmed_id}/studies".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        pubmed_id (str):
        format_ (PublicationsStudiesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
