...
from ...models.assemblies_analyses_list_format import AssembliesAnalysesListFormat
...
def _get_kwargs(
    accession: str,
    *,
    format_: AssembliesAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/assemblies/{accession}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AssembliesAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
