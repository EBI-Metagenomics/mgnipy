...
from ...models.pipeline_tools_list_format import PipelineToolsListFormat
from ...types import (
    UNSET,
    Response,
    Unset,
...
def _get_kwargs(
    *,
    format_: PipelineToolsListFormat | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        format_ (PipelineToolsListFormat | Unset):
        page (int | Unset):
        page_size (int | Unset):
