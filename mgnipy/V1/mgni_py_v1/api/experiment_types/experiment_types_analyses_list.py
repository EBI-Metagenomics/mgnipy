...
from ...models.experiment_types_analyses_list_format import (
...
def _get_kwargs(
    experiment_type: str,
    *,
    format_: ExperimentTypesAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/experiment-types/{experiment_type}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        experiment_type (str):
        format_ (ExperimentTypesAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
