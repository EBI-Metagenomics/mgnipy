...
from ...models.analyses_taxonomy_ssu_list_format import AnalysesTaxonomySsuListFormat
...
def _get_kwargs(
    accession: str,
    *,
    format_: AnalysesTaxonomySsuListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analyses/{accession}/taxonomy/ssu".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnalysesTaxonomySsuListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
