...
from ...models.analyses_taxonomy_unite_list_format import (
...
def _get_kwargs(
    accession: str,
    *,
    format_: AnalysesTaxonomyUniteListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analyses/{accession}/taxonomy/unite".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnalysesTaxonomyUniteListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
