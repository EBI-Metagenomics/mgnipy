...
from ...models.analyses_taxonomy_list_format import AnalysesTaxonomyListFormat
...
def _get_kwargs(
    accession: str,
    *,
    format_: AnalysesTaxonomyListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analyses/{accession}/taxonomy".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnalysesTaxonomyListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
