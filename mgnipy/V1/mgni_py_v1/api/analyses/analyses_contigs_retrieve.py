...
from ...models.analyses_contigs_retrieve_format import AnalysesContigsRetrieveFormat
...
def _get_kwargs(
    ...
    contig_id: str,
    *,
    format_: AnalysesContigsRetrieveFormat | Unset = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analyses/{accession}/contigs/{contig_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        contig_id (str):
        format_ (AnalysesContigsRetrieveFormat | Unset):
