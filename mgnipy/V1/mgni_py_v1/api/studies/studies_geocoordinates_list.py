...
def _get_kwargs(
    accession: str,
    *,
    format_: StudiesGeocoordinatesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/studies/{accession}/geocoordinates".format(
...
) -> PaginatedSampleGeoCoordinateList | None:
    if response.status_code == 200:
        response_200 = PaginatedSampleGeoCoordinateList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedSampleGeoCoordinateList]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (StudiesGeocoordinatesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
