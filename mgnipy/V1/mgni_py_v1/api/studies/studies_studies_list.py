...
from ...models.studies_studies_list_format import StudiesStudiesListFormat
...
def _get_kwargs(
    accession: str,
    *,
    format_: StudiesStudiesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/studies/{accession}/studies".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (StudiesStudiesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
