...
from ...models.studies_publications_list_format import StudiesPublicationsListFormat
...
def _get_kwargs(
    accession: str,
    *,
    format_: StudiesPublicationsListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/studies/{accession}/publications".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (StudiesPublicationsListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
