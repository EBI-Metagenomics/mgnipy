...
def _get_kwargs(
    *,
    body: GenomeUploadSearch | GenomeUploadSearch | Unset = UNSET,
    format_: GenomesSearchGatherCreateFormat | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, GenomeUploadSearch):
...
def sync_detailed(
    *,
    ...
    """
    Args:
        format_ (GenomesSearchGatherCreateFormat | Unset):
        body (GenomeUploadSearch):
        body (GenomeUploadSearch):
