...
def _get_kwargs(
    lineage: str,
    *,
    format_: AnnotationsOrganismsAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/annotations/organisms/{lineage}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        lineage (str):
        format_ (AnnotationsOrganismsAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
