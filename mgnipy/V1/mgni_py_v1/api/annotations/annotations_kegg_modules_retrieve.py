...
from ...models.annotations_kegg_modules_retrieve_format import (
...
def _get_kwargs(
    accession: str,
    *,
    format_: AnnotationsKeggModulesRetrieveFormat | Unset = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/annotations/kegg-modules/{accession}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnnotationsKeggModulesRetrieveFormat | Unset):
