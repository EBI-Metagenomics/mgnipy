...
from ...models.annotations_genome_properties_analyses_list_format import (
...
def _get_kwargs(
    accession: str,
    *,
    format_: AnnotationsGenomePropertiesAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/annotations/genome-properties/{accession}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnnotationsGenomePropertiesAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
