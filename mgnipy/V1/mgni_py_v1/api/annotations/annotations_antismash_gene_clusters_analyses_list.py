...
from ...models.annotations_antismash_gene_clusters_analyses_list_format import (
...
def _get_kwargs(
    accession: str,
    *,
    format_: AnnotationsAntismashGeneClustersAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/annotations/antismash-gene-clusters/{accession}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnnotationsAntismashGeneClustersAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
