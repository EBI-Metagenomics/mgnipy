...
from ...models.annotations_go_terms_analyses_list_format import (
...
def _get_kwargs(
    accession: str,
    *,
    format_: AnnotationsGoTermsAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/annotations/go-terms/{accession}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (AnnotationsGoTermsAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
