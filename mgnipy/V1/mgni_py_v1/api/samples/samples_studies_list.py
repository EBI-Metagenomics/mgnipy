...
from ...models.samples_studies_list_format import SamplesStudiesListFormat
...
def _get_kwargs(
    accession: str,
    *,
    format_: SamplesStudiesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/samples/{accession}/studies".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accession (str):
        format_ (SamplesStudiesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
