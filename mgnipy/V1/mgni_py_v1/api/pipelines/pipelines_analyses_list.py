...
from ...models.pipelines_analyses_list_format import PipelinesAnalysesListFormat
from ...types import (
    UNSET,
    Response,
    Unset,
...
def _get_kwargs(
    release_version: str,
    *,
    format_: PipelinesAnalysesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/pipelines/{release_version}/analyses".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        release_version (str):
        format_ (PipelinesAnalysesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
