...
from ...models.pipelines_samples_list_format import PipelinesSamplesListFormat
from ...types import (
    UNSET,
    Response,
    Unset,
...
def _get_kwargs(
    release_version: str,
    *,
    format_: PipelinesSamplesListFormat | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/pipelines/{release_version}/samples".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        release_version (str):
        format_ (PipelinesSamplesListFormat | Unset):
        ordering (str | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
