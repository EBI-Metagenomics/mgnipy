...
from ..models.genome_catalogue_list_catalogue_type import GenomeCatalogueListCatalogueType
from ..models.genome_catalogue_list_status import GenomeCatalogueListStatus
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  ...
  from ..models.genome_catalogue_list_other_stats_type_0 import GenomeCatalogueListOtherStatsType0
...
T = TypeVar("T", bound="GenomeCatalogueList")



@_attrs_define
class GenomeCatalogueList:
    """ 
        Attributes:
            catalogue_id (str):
            version (str):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.other_stats, GenomeCatalogueListOtherStatsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GenomeCatalogueListStatus(d.pop("status"))
        ...
        catalogue_type = GenomeCatalogueListCatalogueType(d.pop("catalogue_type"))




        def _parse_other_stats(data: object) -> GenomeCatalogueListOtherStatsType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                other_stats_type_0 = GenomeCatalogueListOtherStatsType0.from_dict(data)
                ...
                pass
            return cast(GenomeCatalogueListOtherStatsType0 | None, data)
        ...
        genome_catalogue_list.additional_properties = d
        return genome_catalogue_list
