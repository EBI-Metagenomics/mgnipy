...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/metagenomics/api/v2/studies/insdc/{accession}".format(accession=quote(str(accession), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> MGnifyStudyAccessionLookup | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[MGnifyStudyAccessionLookup]:
    return Response(
