...
`mgni_py_v1` is a python library that was automatically generated from the MGnify API_v1 schema available [here](https://www.ebi.ac.uk/metagenomics/api/schema) using [openapi-python-client](https://github.com/openapi-generators/openapi-python-client). An example of the command that was used:
...
1. generate the python client library `mgni-py-v1` using `openapi-python-client generate`
...
```python
from mgni_py_v1 import AuthenticatedClient
...
```python
from mgni_py_v1.models import MyDataModel
...
1. Any endpoint which did not have a tag will be in `mgni_py_v1.api.default`
