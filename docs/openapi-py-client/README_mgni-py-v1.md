# MGnify API_v1 python client submodule
...
`mgnipy.V1.mgni_py_v1` is a python library that was automatically generated from the MGnify API_v1 schema available [here](https://www.ebi.ac.uk/metagenomics/api/schema) using [openapi-python-client](https://github.com/openapi-generators/openapi-python-client). An example of the command that was used:

```shell
openapi-python-client generate \
    --path "MGnify API (emgapi_v1).yaml" \
    --output-path "mgnipy/openapi/mgni-py-v1" \
    --config "config_v1.yaml" \
    --overwrite 
```

Specifically **_./autogen_clients.sh_** was used to generate the python client library `mgni-py-v1` using `openapi-python-client generate`
...
```python
from mgnipy.V1.mgni_py_v1 import AuthenticatedClient
...
```python
from mgnipy.V1.mgni_py_v1.models import MyDataModel
from mgnipy.V1.mgni_py_v1.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `mgnipy.V1.mgni_py_v1.api.default`
