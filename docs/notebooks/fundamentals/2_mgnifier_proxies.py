...
# > `mgnipy.MGnipy().studies` is the exact same as `mgnipy.V2.proxies.studies.Studies()` which is just a `mgnipy.MGnifier(resource="studies")` with added `studies`-specific functions.
#
